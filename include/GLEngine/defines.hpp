...
#define GLE_MATERIAL_DIFFUSE_TEX_SLOT GL_TEXTURE0 // default texture slot of diffuse maps
#define GLE_MATERIAL_SPECULAR_TEX_SLOT GL_TEXTURE1 // default texture slot of specular maps

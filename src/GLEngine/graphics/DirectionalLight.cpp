...
DirectionalLight::DirectionalLight(const glm::vec3 &rotation,
...
{
    shaderProgram.UniformVec3(("directionalLight[" + std::to_string(structArrayIndex) + "].direction").c_str(), this->rotation);
